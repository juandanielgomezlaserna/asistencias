<div class="bg-[#fff] p-5 shadow-lg rounded-[0.5rem] w-full flex flex-col">
    <a class="bg-[#3eaa36] px-[10px] rounded-full text-[white] font-bold text-xl w-[50px] h-[50px] flex items-center justify-center mb-2" href="/coordinador/new">+</a>
                ...
                foreach ($coordinadores as $key => $value) {
                    ...
                    echo "<div class='flex'>
                        ...
                        <div class='buttons w-[40%] h-[40px] text-center overflow-hidden border-t-2 border-t-[#3eaa36] py-2'>
                            <a class='p-2 py-1 text-[#fff] bg-blue-400 rounded-full' href='/coordinador/view/$value->id'>Consultar</a>
                            <a class='p-2 py-1 text-[#fff] bg-green-500 rounded-full' href='/coordinador/edit/$value->id'>Editar</a>
                            <a class='p-2 py-1 text-[#fff] bg-red-600 rounded-full' href='/coordinador/delete/$value->id'>Eliminar</a>
                        </div>
                    </div>";
                }
            }
