<div class="flex flex-col items-center justify-center h-[100vh] gap-5">
    <form action="/login/initInstructor" method="post" class="flex flex-col bg-[#fffa] rounded-[0.5rem] shadow-[10px_10px_20px_5px_#000] p-5 px-[5rem] items-center justify-center gap-5">
        <h2 class="text-[25px] text-green-600 font-bold">Login Instructor</h2>
